...
namespace NPOIExcel.Constant
{
    public static class MimeTypeNames
    {
        ...
        public const string string_0 = "video/x-flv";
        public const string ImageGif = "image/gif";
        public const string string_1 = "text/x-gwt-rpc";
        ...
        public const string string_2 = "audio/x-ms-wax";
        public const string string_3 = "audio/x-ms-wma";
        public const string string_4 = "video/x-ms-wmv";
        public const string ModelVrml = "model/vrml";
        public const string string_5 = "model/x3d+xml";
